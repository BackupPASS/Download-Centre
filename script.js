...
async function handleWindowsBetaClick() {
  ...
  firebase.auth().signInWithEmailAndPassword(email, password)
    .then(() => {
      const betaUrl = 'https://github.com/BackupPASS/Download-Centre/releases/download/V3.2.0/Vinti-3.2.0-setup.exe';
...
(function renderVinti() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/Download-Centre/releases/download/V3.2.0/Vinti-3.2.0-setup.exe';
