...
(function renderVinti() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/Download-Centre/releases/download/V2.70.75/Vinti-2.70.75-setup.exe';
...
(function renderHub() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/PlingifyPlug-Hub/releases/download/V1.0.25/PlingifyPlug-Hub-Setup-1.0.25.exe';
    card = createDownloadCard(
      'Windows Users',
