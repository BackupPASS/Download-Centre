...
async function handleWindowsBetaClick() {
  ...
  firebase.auth().signInWithEmailAndPassword(email, password)
    .then(() => {
      const betaUrl = 'https://github.com/BackupPASS/Download-Centre/releases/download/V2.70.15/Vinti_Setup_2.70.15.exe';
...
(function renderVinti() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/Download-Centre/releases/download/V2.70.81/Vinti-2.70.81-setup.exe';
...
(function renderHub() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/PlingifyPlug-Hub/releases/download/V1.0.30/PlingifyPlug-Hub-Setup-1.0.30.exe';
    card = createDownloadCard(
      'Windows Users',
