...
(function renderVinti() {
  let card;
  if (os.id === 'windows') {
    const link = 'https://github.com/BackupPASS/Download-Centre/releases/download/V2.70.50/Vinti_Setup_2.70.50.exe';
    ...
    const link = 'https://github.com/BackupPASS/Download-Centre/releases/download/V2.70.20/Vinti-2.70.40.dmg';
    card = createDownloadCard(
      'macOS Users',
